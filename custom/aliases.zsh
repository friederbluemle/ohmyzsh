...
alias initignore='[ ! -f ".gitignore" ] && echo ".DS_Store\n.idea/\nnode_modules/" > .gitignore || echo ".gitignore already exists"'
...
alias pi='pushd ios && pod install && popd'
alias pii='pi && yi'
...
alias re='find . -type f -iname "readme*" -maxdepth 1 | xargs bat'
alias rea='find . -type f -iname "readme*" | xargs bat'
alias hp='head package.json'
alias hpl='head package-lock.json'
...
alias gdt='git diff ..`git rev-parse --abbrev-ref --symbolic-full-name @{u}`'
...
alias gri1='git rebase -i HEAD~2'
alias gri2='git rebase -i HEAD~3'
alias gri3='git rebase -i HEAD~4'
alias gri4='git rebase -i HEAD~5'
alias grii='git rebase -i init'
...
alias gp='git push'
alias gpf='git push -u fb'
alias gpo='git push -u origin HEAD'
alias gpff='git push --force-with-lease fb'
alias gpfo='git push --force-with-lease'
alias gfb='branch="`gbr 2>/dev/null`" && gcm && gfa && gm && git push fb && gb -d $branch'
